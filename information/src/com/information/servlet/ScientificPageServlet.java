...
public class ScientificPageServlet extends HttpServlet{
	/**
	 * 
	 */
	public void init(ServletConfig config) throws ServletException {
		...
		super.init(config);
		System.out.println("已经实例化了ScientificPageServlet");
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		PageEntity<ScientificEntity> scientific = null;
		...
		jsonObject = JSONObject.fromObject(params);
	  	...
	  	scientific = lg.scientificinfo(pageNo, pageSize, new Object[] {departmentId, categoryId, rank, clock1, clock2, uName, userinfoId});
		System.out.println(scientific);
		Map<String, Object> map = new HashMap<String,Object>();
		
		map.put("tableData", scientific.getList());
		map.put("totalCount", scientific.getTotalPageNumber()*pageSize);
