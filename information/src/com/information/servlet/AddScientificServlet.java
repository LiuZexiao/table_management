...
public class AddScientificServlet extends HttpServlet {	
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		int log=lg.addScientific(workNum, name, categoryId, proName, proSource, rank, certificationTime, situation, departmentId);
