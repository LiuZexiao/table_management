<template>
    <div>
        ...
        <div style="float: left; margin: 20px 0 10px 50px; display: flex">
            <el-date-picker v-model="time" style="width: 230px" type="daterange" align="right" unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions2"></el-date-picker>
             <el-select clearable v-show="depart" v-model="department" placeholder="部门" style="width: 120px">
            ...
            <el-select clearable v-model="selectTable.identity" placeholder="身份" style="width: 80px">
                <el-option label="学生" value="学生"></el-option>
                <el-option label="教师" value="教师"></el-option>
            </el-select>
            <el-select clearable v-model="selectTable.type" placeholder="竞赛种类" style="width: 110px">
                <el-option label="学科" value="学科"></el-option>
        ...
        <el-table ref="multipleTable" :data="tableData" border tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" >
            ...
            <el-table-column prop="certificationTime" label="获奖时间" width="80" ></el-table-column>
            <el-table-column prop="semester" label="学期" width="140" >
                <!-- <template slot-scope="scope">{{ scope.row.date }}</template> -->
            </el-table-column>
            <el-table-column prop="name" label="姓名" width="80" ></el-table-column>
            <el-table-column prop="department" label="系部" width="120" show-overflow-tooltip></el-table-column>
            <el-table-column prop="identity" label="身份" width="80" show-overflow-tooltip></el-table-column>
            <el-table-column prop="proName" label="获奖项目"   show-overflow-tooltip></el-table-column>
            <el-table-column prop="type" label="竞赛种类" width="80"  show-overflow-tooltip></el-table-column>
            <el-table-column prop="rank" label="级别"  width="100"  show-overflow-tooltip></el-table-column>
            <el-table-column prop="grade" label="等级" width="100" show-overflow-tooltip></el-table-column>
        ...
        <my-dialogSkill :research='research' :info='info'></my-dialogSkill>   
    </div>
</template>

<script>
    import dialogSkill from '../dialog/dialogSkill'
    ...
    export default {
        ...
        methods: {
            ...
            handleDelete(index, row) {    //删除
                ...
                this.$confirm('此操作将永久删除该账号, 是否继续?', '提示', {
                    ...
                    this.$axios.post('/api/DeleteAwardServlet',Params)
                            .then((res) => {
                                if(res.data.code == 0){
                                    this.$message({
                                        type: 'success',
            ...
            output(){
                ...
                let params = {
                    ...
                    identity: selectTable.identity,
                    rank: selectTable.rank,  // 级别
                    type: selectTable.type,
                ...
                this.$axios.post('/api/OutPutAwardServlet',params,{responseType: 'arraybuffer'})
                            .then((res) => {
                    ...
                    link.href = url
                    link.setAttribute('download', '科研获奖.xls')
            ...
            select() {    // 查询条件
                ...
                let Params = {
                    ...
                    if (!(Params.identity || this.department || Params.rank || Params.type || selectTable.uName ||  Params.clock1 ||Params.clock2 )){
                        this.$message({
                                showClose: true,
                                message: '请选择查询条件！\n',
                                type: 'warning',
        ...
        //     })
            ...
            loadData(pageNum, pageSize){    // 当前页码；每页所含有的数据量
                    ...
                    this.$axios.post('/api/AwardPageServlet',params)
                                .then((res) => {
